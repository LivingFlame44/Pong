...
public class Ball : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D actor)
    {
        ...
        {
            float y = calculatePosition(transform.position,
            actor.transform.position, actor.collider.bounds.size.y);
    ...
    float calculatePosition(Vector2 ballPosition, Vector2 panelPosition, float
    panelHeight)
    {
